...
def parse_run_log_text(text: str) -> RunLogSnapshot:
    ...
    for raw_line in text.splitlines():
        ...
        if event == "HEAD_SENT":
            ...
            if parsed_market is not None and not market_snapshots:
                market_snapshot = parsed_market
        elif event in {
            "COMMAND_FAILED",
            "HEAD_CANCELLED",
...
def render_market_snapshot_table(
    ...
    *,
    ...
    if snapshot is None:
        ...
        if snapshots:
            body.extend(_market_snapshot_stat_rows(tuple(snapshots), options=options))
    return _format_table(
        headers,
        body,
...
def render_run_report(
    ...
    *,
    ...
    if financial_overview is not None:
        sections.append(render_financial_overview_table(financial_overview, options=options))
    sections.extend(
        (
...
def render_org_report(
    ...
    *,
    ...
    return render_run_report(
        ...
        latest_log_at=report.latest_log_at,
